...
helm install argocd argo/argo-cd \
    ...
    --create-namespace \
    --namespace argocd \
    --values https://raw.githubusercontent.com/unchama/fivem-project/"${TARGET_BRANCH}"/k8s-manifests/argocd-helm-chart-values.yaml
helm install argocd argo/argocd-apps \
    --version 0.0.1 \
    --values https://raw.githubusercontent.com/unchama/fivem-project/"${TARGET_BRANCH}"/k8s-manifests/argocd-apps-helm-chart-values.yaml
