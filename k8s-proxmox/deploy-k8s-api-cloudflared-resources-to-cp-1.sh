...
cloudflare_cert_pem="$(/bin/bash <(curl -s "${k8s_definition_base_url}/k8s-proxmox/cluster-boot-up/scripts/local-terminal/obtain-cloudflared-cert.sh") "${target_branch}")"
